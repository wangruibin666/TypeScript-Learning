...
export default class MyLocalStorage {
  ...
  public static getInstance() { // 每次调用保证只会返回相同的实例对象
...
**总结2：**一旦为静态方法或静态属性分配好空间，就一直保存到内存中，直到服务器重启或者控制台程序执行结束才被释放。
 ...
 ![img](file:///C:\Users\Administrator\AppData\Roaming\Tencent\Users\1099690237\QQ\WinTemp\RichOle\W{IPE`[5$%PE]C%DXNBE%IA.png) 
